...
#!# NOTEL: In General If we have n-Function Calls then Python Programmer Must Define n-Function Defintions . This is Process is Time consuming Process.

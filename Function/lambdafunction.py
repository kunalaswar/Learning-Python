...
#!Normal function
# def sumop(a,b): #^finction defination
#     c=a+b
#     return c
...
# sumop=lambda a,b: a+b  #^ finction defination
...
# res=sumop(x,y)    
# print("sum =>",res)
# k,v=int(input("Entre a first number for normal fun :")),int(input("Entre a second number for normal fun : "))
# res=sumop(k,v)
# print("sum =>",res)
...
# a,b,c=int(input("Entre first value")),int(input("Entre second value")),int(input("Entre third value"))
# res=findbig(a,b,c)
# print("Big value =",res)
...
# a,b,c=int(input("Entre a first value")),int(input("Entre a first value")),int(input("Entre a first value"))
# res=var1(a,b,c)
